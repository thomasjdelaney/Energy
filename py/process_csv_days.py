...
raw_file_list = glob.glob(os.path.join(csv_dir, 'EDFEnergy*.csv')) # requires naming convention
...
weather_file_list = glob.glob(os.path.join(csv_dir, 'bristol_weather_*.csv')) # requires naming convention
